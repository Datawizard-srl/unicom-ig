Instance: DOCTIVERINE-F.C.TAB-20MG-TAB
InstanceOf: Bundle
Usage: #example

* type = #transaction

* entry[0].resource = DOCTIVERINE-F.C.TAB-20MG-TAB-MPD
* entry[=].request.method = #PUT
* entry[=].request.url = "MedicinalProductDefinition/DOCTIVERINE-F.C.TAB-20MG-TAB-MPD"
* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/MedicinalProductDefinition/DOCTIVERINE-F.C.TAB-20MG-TAB-MPD"

* entry[+].resource = DOCTIVERINE-F.C.TAB-20MG-TAB-RA
* entry[=].request.method = #PUT
...
* entry[+].resource = DOCTIVERINE-F.C.TAB-20MG-TAB-APD
* entry[=].request.method = #PUT
* entry[=].request.url = "AdministrableProductDefinition/DOCTIVERINE-F.C.TAB-20MG-TAB-APD"
* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/AdministrableProductDefinition/DOCTIVERINE-F.C.TAB-20MG-TAB-APD"

* entry[+].resource = DOCTIVERINE-F.C.TAB-20MG-TAB-MID
* entry[=].request.method = #PUT
* entry[=].request.url = "ManufacturedItemDefinition/DOCTIVERINE-F.C.TAB-20MG-TAB-MID"
* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/ManufacturedItemDefinition/DOCTIVERINE-F.C.TAB-20MG-TAB-MID"

* entry[+].resource = DOCTIVERINE-F.C.TAB-20MG-TAB-I
* entry[=].request.method = #PUT
* entry[=].request.url = "Ingredient/DOCTIVERINE-F.C.TAB-20MG-TAB-I"
* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/Ingredient/DOCTIVERINE-F.C.TAB-20MG-TAB-I"

* entry[+].resource = DOCTIVERINE-F.C.TAB-20MG-TAB-PPD
* entry[=].request.method = #PUT
* entry[=].request.url = "PackagedProductDefinition/DOCTIVERINE-F.C.TAB-20MG-TAB-PPD"
* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/PackagedProductDefinition/DOCTIVERINE-F.C.TAB-20MG-TAB-PPD"
...
Instance: DOCTIVERINE-F.C.TAB-20MG-TAB-RA
InstanceOf: PPLRegulatedAuthorization
Usage: #inline

* identifier.value = "None"
* subject = Reference(DOCTIVERINE-F.C.TAB-20MG-TAB-MPD)
...
Instance: DOCTIVERINE-F.C.TAB-20MG-TAB-APD
InstanceOf: PPLAdministrableProductDefinition
Usage: #inline
* status = #active
* formOf = Reference(DOCTIVERINE-F.C.TAB-20MG-TAB-MPD)
* administrableDoseForm = $200000000004#100000073665 "Film-coated tablet"
* unitOfPresentation = $200000000014#200000002152 "Tablet"
* producedFrom = Reference(DOCTIVERINE-F.C.TAB-20MG-TAB-MID)
...
Instance: DOCTIVERINE-F.C.TAB-20MG-TAB-I
InstanceOf: PPLIngredient
Usage: #inline
* status = #active
* for[0] = Reference(DOCTIVERINE-F.C.TAB-20MG-TAB-MPD)
* for[+] = Reference(DOCTIVERINE-F.C.TAB-20MG-TAB-MID)
* for[+] = Reference(DOCTIVERINE-F.C.TAB-20MG-TAB-APD)
