...
* routeOfAdministration.code = $100000073345#20070000 "Transdermal use"
...
Usage: #inline
* status = #active
* manufacturedDoseForm = $200000000004#10506000 "{'code': '100000073714', 'display': 'Medicated plaster'}"
* unitOfPresentation = $200000000014#20070000 "Transdermal use"
...
* containedItemQuantity = 0 $200000000014#200000002134 "Patch"
