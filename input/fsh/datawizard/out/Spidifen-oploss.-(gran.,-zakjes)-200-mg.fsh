...
Usage: #inline
* status = #active
* manufacturedDoseForm = $200000000004#10112000 "{'code': '100000073365', 'display': 'Granules for oral solution'}"
...
* substance.code.concept = $sms#100000092228 "{'code': '100000092228', 'display': 'Ibuprofen arginine'}"
* substance.strength.presentationRatio.numerator =  $100000110633# ""
* substance.strength.presentationRatio.denominator =  $200000000014# ""
* substance.strength.referenceStrength.substance.concept = $sms#100000092228 "{'code': '100000092228', 'display': 'Ibuprofen arginine'}"
