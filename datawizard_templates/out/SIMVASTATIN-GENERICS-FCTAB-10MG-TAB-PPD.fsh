Instance: SIMVASTATIN-GENERICS-FCTAB-10MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-GENERICS-PHARMA-HELLAS-EPE-film-coated-tablet-30-x-10mg-" //pcId ?
* packageFor = Reference(SIMVASTATIN-GENERICS-FCTAB-10MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(SIMVASTATIN-GENERICS-FCTAB-10MG-TAB-MID)
