Instance: PLACOL-SIMVASTATIN-FCTAB-20-MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-BENNETT-PhARMAKEUTIKE-AE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(PLACOL-SIMVASTATIN-FCTAB-20-MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(PLACOL-SIMVASTATIN-FCTAB-20-MG-TAB-MID)
