Instance: LIPOREX-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-GENEPHARM-AE-film-coated-tablet-10-x-40mg-" //pcId ?
* packageFor = Reference(LIPOREX-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(LIPOREX-FCTAB-40MG-TAB-MID)
