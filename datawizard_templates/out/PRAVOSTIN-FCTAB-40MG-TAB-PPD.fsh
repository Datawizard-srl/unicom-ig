Instance: PRAVOSTIN-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-MINERBA-PhARMAKEUTIKE-AE-film-coated-tablet-28-x-40mg-" //pcId ?
* packageFor = Reference(PRAVOSTIN-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(PRAVOSTIN-FCTAB-40MG-TAB-MID)
