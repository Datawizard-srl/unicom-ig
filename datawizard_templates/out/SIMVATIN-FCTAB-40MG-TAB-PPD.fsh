Instance: SIMVATIN-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-BIOSPRAY-ABEE-film-coated-tablet-10-x-40mg-" //pcId ?
* packageFor = Reference(SIMVATIN-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(SIMVATIN-FCTAB-40MG-TAB-MID)
//* packaging.packaging.containedItem.amount.value = 30
Instance: SIMVATIN-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-DAST-BIOTECH-PHARM-EPE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(SIMVATIN-FCTAB-40MG-TAB-MPD)
