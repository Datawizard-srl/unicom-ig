Instance: LIPOPRESS-FCTAB-40-MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-HEREMCO-MEPE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(LIPOPRESS-FCTAB-40-MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(LIPOPRESS-FCTAB-40-MG-TAB-MID)
