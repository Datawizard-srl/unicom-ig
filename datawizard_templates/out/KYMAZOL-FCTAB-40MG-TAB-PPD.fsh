Instance: KYMAZOL-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-RAFARM-AEBE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(KYMAZOL-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(KYMAZOL-FCTAB-40MG-TAB-MID)
