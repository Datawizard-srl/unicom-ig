...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-RAFARM-AEBE-capsule-hard-14-x-10mg-" //pcId ?
...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-RAFARM-AEBE-capsule-hard-28-x-10mg-" //pcId ?
* packageFor = Reference(RAMLET-CAPS-10MG-CAP-MPD)
