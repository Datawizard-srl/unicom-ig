Instance: DOCTIVERINE-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-DOCTUM-PhARMAKEUTIKE-K-GIOKARES-and-SIA-AE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(DOCTIVERINE-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(DOCTIVERINE-FCTAB-20MG-TAB-MID)
