Instance: NUROFEN-SOFTCAPS-200MG-CAP-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-ibuprofen-REKIT-MPENKIZER-ELLAS-KhEMIKA-ABEE-capsule-soft-16vial-x-200mg-" //pcId ?
* packageFor = Reference(NUROFEN-SOFTCAPS-200MG-CAP-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(NUROFEN-SOFTCAPS-200MG-CAP-MID)
