...
* identifier[pcid].value = "BEL-BEL-simvastatine-Mylan-film-coated-tablet-250-x-40mg-" //pcId ?
...
* identifier[pcid].value = "BEL-BEL-simvastatine-Mylan-film-coated-tablet-56-x-40mg-" //pcId ?
* packageFor = Reference(simvastine-Mylan-filmomh-tabl-deelb-40-mg-MPD)
