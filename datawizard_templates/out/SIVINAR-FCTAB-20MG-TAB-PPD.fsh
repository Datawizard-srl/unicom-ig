Instance: SIVINAR-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-ANPhARM-ELLAS-AE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(SIVINAR-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(SIVINAR-FCTAB-20MG-TAB-MID)
