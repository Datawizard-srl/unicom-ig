Instance: STATOSAN-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-PHARMAXIA-HELLAS-EE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(STATOSAN-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(STATOSAN-FCTAB-20MG-TAB-MID)
