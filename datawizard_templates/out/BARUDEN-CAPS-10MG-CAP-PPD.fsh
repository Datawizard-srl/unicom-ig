...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-ANPhARM-ELLAS-AE-capsule-hard-14-x-10mg-" //pcId ?
...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-ANPhARM-ELLAS-AE-capsule-hard-28-x-10mg-" //pcId ?
* packageFor = Reference(BARUDEN-CAPS-10MG-CAP-MPD)
