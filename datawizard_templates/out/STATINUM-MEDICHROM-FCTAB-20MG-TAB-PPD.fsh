Instance: STATINUM-MEDICHROM-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-MEDICHROM-AE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(STATINUM-MEDICHROM-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(STATINUM-MEDICHROM-FCTAB-20MG-TAB-MID)
