Instance: TEGRETOL-CORFCT-400MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-carbamazepine-NOVARTIS-HELLAS-AEBE-prolonged-release-tablet-30-x-400mg-" //pcId ?
* packageFor = Reference(TEGRETOL-CORFCT-400MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(TEGRETOL-CORFCT-400MG-TAB-MID)
