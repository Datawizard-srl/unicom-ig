Instance: STASIVA-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-PhARMANEL-PhARMAKEUTIKE-AE-film-coated-tablet-10-x-20mg-" //pcId ?
* packageFor = Reference(STASIVA-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(STASIVA-FCTAB-20MG-TAB-MID)
//* packaging.packaging.containedItem.amount.value = 30
Instance: STASIVA-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-PhARMANEL-PhARMAKEUTIKE-AE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(STASIVA-FCTAB-20MG-TAB-MPD)
...
* identifier[pcid].value = "GRC-GRC-Simvastatin-BIAN-AE-film-coated-tablet-60-x-20mg-" //pcId ?
* packageFor = Reference(STASIVA-FCTAB-20MG-TAB-MPD)
