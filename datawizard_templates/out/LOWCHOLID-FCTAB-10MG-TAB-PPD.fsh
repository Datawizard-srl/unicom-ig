Instance: LOWCHOLID-FCTAB-10MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-PLUS-PhARMAKEUTIKE-AE-film-coated-tablet-30-x-10mg-" //pcId ?
* packageFor = Reference(LOWCHOLID-FCTAB-10MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(LOWCHOLID-FCTAB-10MG-TAB-MID)
