...
* identifier[pcid].value = "GRC-GRC-amlodipine-maleate-GENERICS-PHARMA-HELLAS-EPE-tablet-14-x-10mg-" //pcId ?
...
* identifier[pcid].value = "GRC-GRC-amlodipine-maleate-GENERICS-PHARMA-HELLAS-EPE-tablet-28-x-10mg-" //pcId ?
* packageFor = Reference(amlodipine-maleate-GENERICS-TAB-10MG-TAB-MPD)
