Instance: PEDEA-SOLIVINF-10MG-2ML-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-ibuprofen-sodium-IPhET-AE-solution-for-infusion-4ampoule-x-10mg-2mL" //pcId ?
* packageFor = Reference(PEDEA-SOLIVINF-10MG-2ML-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(PEDEA-SOLIVINF-10MG-2ML-MID)
