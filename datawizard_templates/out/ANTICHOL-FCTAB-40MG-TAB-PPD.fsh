Instance: ANTICHOL-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-HELP-ABEE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(ANTICHOL-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(ANTICHOL-FCTAB-40MG-TAB-MID)
//* packaging.packaging.containedItem.amount.value = 30
Instance: ANTICHOL-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-HELP-ABEE-film-coated-tablet-60-x-40mg-" //pcId ?
* packageFor = Reference(ANTICHOL-FCTAB-40MG-TAB-MPD)
...
* identifier[pcid].value = "GRC-GRC-Simvastatin-HELP-ABEE-film-coated-tablet-10-x-40mg-" //pcId ?
* packageFor = Reference(ANTICHOL-FCTAB-40MG-TAB-MPD)
