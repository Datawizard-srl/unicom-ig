...
* identifier[pcid].value = "BEL-BEL-simvastatine-Mylan-film-coated-tablet-250-x-20mg-" //pcId ?
...
* identifier[pcid].value = "BEL-BEL-simvastatine-Mylan-film-coated-tablet-28-x-20mg-" //pcId ?
* packageFor = Reference(simvastine-Mylan-filmomh-tabl-deelb-20-mg-MPD)
