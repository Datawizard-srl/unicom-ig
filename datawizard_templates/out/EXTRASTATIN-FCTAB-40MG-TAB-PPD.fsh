Instance: EXTRASTATIN-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-SJA-PHARM-EPE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(EXTRASTATIN-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(EXTRASTATIN-FCTAB-40MG-TAB-MID)
