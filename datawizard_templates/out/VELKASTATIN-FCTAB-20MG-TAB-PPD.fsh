Instance: VELKASTATIN-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-BELKA-ELLAS-AEBE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(VELKASTATIN-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(VELKASTATIN-FCTAB-20MG-TAB-MID)
