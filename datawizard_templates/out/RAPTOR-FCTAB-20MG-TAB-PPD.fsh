Instance: RAPTOR-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-MEDITRINA-EPE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(RAPTOR-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(RAPTOR-FCTAB-20MG-TAB-MID)
