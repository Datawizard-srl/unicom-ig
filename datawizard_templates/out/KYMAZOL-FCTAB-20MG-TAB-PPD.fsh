Instance: KYMAZOL-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-RAFARM-AEBE-film-coated-tablet-10-x-20mg-" //pcId ?
* packageFor = Reference(KYMAZOL-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(KYMAZOL-FCTAB-20MG-TAB-MID)
//* packaging.packaging.containedItem.amount.value = 30
Instance: KYMAZOL-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-RAFARM-AEBE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(KYMAZOL-FCTAB-20MG-TAB-MPD)
