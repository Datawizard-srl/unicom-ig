Instance: STAZOR-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-ADEPhARM-MEPE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(STAZOR-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(STAZOR-FCTAB-40MG-TAB-MID)
