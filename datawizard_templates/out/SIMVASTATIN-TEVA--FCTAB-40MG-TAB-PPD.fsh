Instance: SIMVASTATIN-TEVA--FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-TEVA-PHARMA-BV-Haarlem-THE-NETHERLANDS-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(SIMVASTATIN-TEVA--FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(SIMVASTATIN-TEVA--FCTAB-40MG-TAB-MID)
