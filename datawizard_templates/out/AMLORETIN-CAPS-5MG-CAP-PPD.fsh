...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-NATURALIA-AE-capsule-hard-28-x-5mg-" //pcId ?
...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-NATURALIA-AE-capsule-hard-14-x-5mg-" //pcId ?
* packageFor = Reference(AMLORETIN-CAPS-5MG-CAP-MPD)
