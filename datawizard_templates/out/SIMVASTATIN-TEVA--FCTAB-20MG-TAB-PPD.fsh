Instance: SIMVASTATIN-TEVA--FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-TEVA-PHARMA-BV-Haarlem-THE-NETHERLANDS-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(SIMVASTATIN-TEVA--FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(SIMVASTATIN-TEVA--FCTAB-20MG-TAB-MID)
