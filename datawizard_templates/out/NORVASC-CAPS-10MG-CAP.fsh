Instance: NORVASC-CAPS-10MG-CAP
InstanceOf: Bundle
Usage: #example

* type = #transaction

* entry[0].resource = NORVASC-CAPS-10MG-CAP-MPD
* entry[=].request.method = #PUT
* entry[=].request.url = "MedicinalProductDefinition/NORVASC-CAPS-10MG-CAP-MPD"
* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/MedicinalProductDefinition/NORVASC-CAPS-10MG-CAP-MPD"

* entry[+].resource = NORVASC-CAPS-10MG-CAP-RA
* entry[=].request.method = #PUT
...
* entry[+].resource = NORVASC-CAPS-10MG-CAP-APD
* entry[=].request.method = #PUT
* entry[=].request.url = "AdministrableProductDefinition/NORVASC-CAPS-10MG-CAP-APD"
* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/AdministrableProductDefinition/NORVASC-CAPS-10MG-CAP-APD"

* entry[+].resource = NORVASC-CAPS-10MG-CAP-MID
* entry[=].request.method = #PUT
* entry[=].request.url = "ManufacturedItemDefinition/NORVASC-CAPS-10MG-CAP-MID"
* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/ManufacturedItemDefinition/NORVASC-CAPS-10MG-CAP-MID"

* entry[+].resource = NORVASC-CAPS-10MG-CAP-I
* entry[=].request.method = #PUT
* entry[=].request.url = "Ingredient/NORVASC-CAPS-10MG-CAP-I"
* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/Ingredient/NORVASC-CAPS-10MG-CAP-I"

* entry[+].resource = NORVASC-CAPS-10MG-CAP-PPD
* entry[=].request.method = #PUT
* entry[=].request.url = "PackagedProductDefinition/NORVASC-CAPS-10MG-CAP-PPD"
* entry[=].fullUrl = "https://hl7-eu.github.io/unicom-ig/branches/mpd-r4b/PackagedProductDefinition/NORVASC-CAPS-10MG-CAP-PPD"
...
Instance: NORVASC-CAPS-10MG-CAP-RA
InstanceOf: PPLRegulatedAuthorization
Usage: #inline

* identifier.value = "None"
* subject = Reference(NORVASC-CAPS-10MG-CAP-MPD)
...
Instance: NORVASC-CAPS-10MG-CAP-APD
InstanceOf: PPLAdministrableProductDefinition
Usage: #inline
* status = #active
* formOf = Reference(NORVASC-CAPS-10MG-CAP-MPD)
* administrableDoseForm = $200000000004#100000073375 "Capsule, hard"
* unitOfPresentation = $200000000014#200000002113 "Capsule"
* producedFrom = Reference(NORVASC-CAPS-10MG-CAP-MID)
...
Instance: NORVASC-CAPS-10MG-CAP-I
InstanceOf: PPLIngredient
Usage: #inline
* status = #active
* for[0] = Reference(NORVASC-CAPS-10MG-CAP-MPD)
* for[+] = Reference(NORVASC-CAPS-10MG-CAP-MID)
* for[+] = Reference(NORVASC-CAPS-10MG-CAP-APD)
