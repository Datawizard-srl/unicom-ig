...
* identifier[pcid].value = "GRC-GRC-amlodipine-maleate-PhARMATEN-ELLAS-AEBE-tablet-28-x-10mg-" //pcId ?
...
* identifier[pcid].value = "GRC-GRC-amlodipine-maleate-INNOVIS-PHARMA-AEBE-tablet-30-x-10mg-" //pcId ?
* packageFor = Reference(NOLVAC-TAB-10MG-TAB-MPD)
