Instance: SOTOVASTIN-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-BROS-EPE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(SOTOVASTIN-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(SOTOVASTIN-FCTAB-40MG-TAB-MID)
