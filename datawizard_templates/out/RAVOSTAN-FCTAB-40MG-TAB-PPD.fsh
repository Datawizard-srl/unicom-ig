Instance: RAVOSTAN-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-PLA-PHARMACEUTICALS-AE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(RAVOSTAN-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(RAVOSTAN-FCTAB-40MG-TAB-MID)
