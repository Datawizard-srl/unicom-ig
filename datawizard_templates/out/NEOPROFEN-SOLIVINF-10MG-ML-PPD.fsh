Instance: NEOPROFEN-SOLIVINF-10MG-ML-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-ibuprofen-lysine-IPhET-AE-solution-for-infusion-3vial-x-20mg-2mL" //pcId ?
* packageFor = Reference(NEOPROFEN-SOLIVINF-10MG-ML-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(NEOPROFEN-SOLIVINF-10MG-ML-MID)
