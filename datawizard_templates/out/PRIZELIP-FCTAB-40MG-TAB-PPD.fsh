Instance: PRIZELIP-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-PhERAKON-IKE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(PRIZELIP-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(PRIZELIP-FCTAB-40MG-TAB-MID)
