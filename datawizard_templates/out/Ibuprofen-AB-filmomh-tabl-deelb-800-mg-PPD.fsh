...
* identifier[pcid].value = "BEL-BEL-ibuprofen--Aurobindo-film-coated-tablet-100-x-800mg-" //pcId ?
...
* identifier[pcid].value = "BEL-BEL-ibuprofen--Aurobindo-film-coated-tablet-30-x-800mg-" //pcId ?
* packageFor = Reference(Ibuprofen-AB-filmomh-tabl-deelb-800-mg-MPD)
