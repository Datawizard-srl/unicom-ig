...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-PNG-GEROLUMATOS-MENTIKAL-AE-capsule-hard-14-x-5mg-" //pcId ?
...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-PNG-GEROLUMATOS-MENTIKAL-AE-capsule-hard-28-x-5mg-" //pcId ?
* packageFor = Reference(DAFOR-CAPS-5MG-CAP-MPD)
