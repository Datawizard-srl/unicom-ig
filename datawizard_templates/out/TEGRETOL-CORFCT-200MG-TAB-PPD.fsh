Instance: TEGRETOL-CORFCT-200MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-carbamazepine-NOVARTIS-HELLAS-AEBE-prolonged-release-tablet-50-x-200mg-" //pcId ?
* packageFor = Reference(TEGRETOL-CORFCT-200MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(TEGRETOL-CORFCT-200MG-TAB-MID)
