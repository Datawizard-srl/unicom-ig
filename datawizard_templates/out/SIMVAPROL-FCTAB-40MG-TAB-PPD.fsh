Instance: SIMVAPROL-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-NOVENDIA-PHARMACEUTICALS-EPE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(SIMVAPROL-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(SIMVAPROL-FCTAB-40MG-TAB-MID)
//* packaging.packaging.containedItem.amount.value = 30
Instance: SIMVAPROL-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-NOVENDIA-PHARMACEUTICALS-EPE-film-coated-tablet-50-x-40mg-" //pcId ?
* packageFor = Reference(SIMVAPROL-FCTAB-40MG-TAB-MPD)
