Instance: IAMASTATIN-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-IAMATICA-MON-EPE-film-coated-tablet-10-x-40mg-" //pcId ?
* packageFor = Reference(IAMASTATIN-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(IAMASTATIN-FCTAB-40MG-TAB-MID)
//* packaging.packaging.containedItem.amount.value = 30
Instance: IAMASTATIN-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-IAMATICA-MON-EPE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(IAMASTATIN-FCTAB-40MG-TAB-MPD)
