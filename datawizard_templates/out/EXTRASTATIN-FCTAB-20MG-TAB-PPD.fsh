Instance: EXTRASTATIN-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-SJA-PHARM-EPE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(EXTRASTATIN-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(EXTRASTATIN-FCTAB-20MG-TAB-MID)
