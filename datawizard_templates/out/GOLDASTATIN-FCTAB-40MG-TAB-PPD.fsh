Instance: GOLDASTATIN-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-LINKER-PHARMACEUTICALS-PANAGIOTES-LEON-and-SIA-EE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(GOLDASTATIN-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(GOLDASTATIN-FCTAB-40MG-TAB-MID)
