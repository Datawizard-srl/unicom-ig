Instance: GOLDASTATIN-FCTAB-40MG-TAB-0-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-PANAGIOTES-LEON-and-SIA-EE-film-coated-tablet-20-x-40mg-" //pcId ?
* packageFor = Reference(GOLDASTATIN-FCTAB-40MG-TAB-0-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(GOLDASTATIN-FCTAB-40MG-TAB-0-MID)
