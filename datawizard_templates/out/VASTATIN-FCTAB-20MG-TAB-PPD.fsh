Instance: VASTATIN-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-VOCATE-PhARMAKEUTIKE-AE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(VASTATIN-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(VASTATIN-FCTAB-20MG-TAB-MID)
