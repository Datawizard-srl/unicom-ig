Instance: LIPOPRESS-FCTAB-20-MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-HEREMCO-MEPE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(LIPOPRESS-FCTAB-20-MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(LIPOPRESS-FCTAB-20-MG-TAB-MID)
