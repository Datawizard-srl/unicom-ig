Instance: NUROFEN-CTAB-200MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-ibuprofen-REKIT-MPENKIZER-ELLAS-KhEMIKA-ABEE-coated-tablet-24ampoule-x-200mg-" //pcId ?
* packageFor = Reference(NUROFEN-CTAB-200MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(NUROFEN-CTAB-200MG-TAB-MID)
