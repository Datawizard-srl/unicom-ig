Instance: VASTATIN-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-VOCATE-PhARMAKEUTIKE-AE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(VASTATIN-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(VASTATIN-FCTAB-40MG-TAB-MID)
