Instance: RAVOSTAN-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-PLA-PHARMACEUTICALS-AE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(RAVOSTAN-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(RAVOSTAN-FCTAB-20MG-TAB-MID)
