Instance: ZUROCID-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-STARGEN-EPE-film-coated-tablet-10-x-20mg-" //pcId ?
* packageFor = Reference(ZUROCID-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(ZUROCID-FCTAB-20MG-TAB-MID)
