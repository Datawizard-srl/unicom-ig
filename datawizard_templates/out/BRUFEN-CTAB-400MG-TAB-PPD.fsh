Instance: BRUFEN-CTAB-400MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-ibuprofen-BGP-PROIONTA-MEPE-coated-tablet-24-x-400mg-" //pcId ?
* packageFor = Reference(BRUFEN-CTAB-400MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(BRUFEN-CTAB-400MG-TAB-MID)
