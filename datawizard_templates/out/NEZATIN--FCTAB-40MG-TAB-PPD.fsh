Instance: NEZATIN--FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-GRAMMENIDES-AThANASIOS-TOU-DEMETRIOU-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(NEZATIN--FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(NEZATIN--FCTAB-40MG-TAB-MID)
