...
* identifier[pcid].value = "BEL-BEL-amlodipine-besilate-Upjohn-capsule-hard-28-x-5mg-" //pcId ?
...
* identifier[pcid].value = "BEL-BEL-amlodipine-besilate-Upjohn-capsule-hard-30-x-5mg-" //pcId ?
* packageFor = Reference(Amlor-harde-caps-5-mg-MPD)
...
* identifier[pcid].value = "BEL-BEL-amlodipine-besilate-Upjohn-capsule-hard-56-x-5mg-" //pcId ?
* packageFor = Reference(Amlor-harde-caps-5-mg-MPD)
