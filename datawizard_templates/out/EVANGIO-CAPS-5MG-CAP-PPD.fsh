...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-RAFARM-AEBE-capsule-hard-14-x-5mg-" //pcId ?
...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-RAFARM-AEBE-capsule-hard-30-x-5mg-" //pcId ?
* packageFor = Reference(EVANGIO-CAPS-5MG-CAP-MPD)
