Instance: BRUFEN-FCTAB-600MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-ibuprofen-BGP-PROIONTA-MEPE-film-coated-tablet-24-x-600mg-" //pcId ?
* packageFor = Reference(BRUFEN-FCTAB-600MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(BRUFEN-FCTAB-600MG-TAB-MID)
