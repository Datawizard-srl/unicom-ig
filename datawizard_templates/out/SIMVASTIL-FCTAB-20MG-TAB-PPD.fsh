Instance: SIMVASTIL-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-MEDARTE-PhARMAKEUTIKE-ABEE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(SIMVASTIL-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(SIMVASTIL-FCTAB-20MG-TAB-MID)
