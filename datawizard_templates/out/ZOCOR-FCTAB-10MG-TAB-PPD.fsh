Instance: ZOCOR-FCTAB-10MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-BIANEKs-AE-film-coated-tablet-10-x-10mg-" //pcId ?
* packageFor = Reference(ZOCOR-FCTAB-10MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(ZOCOR-FCTAB-10MG-TAB-MID)
