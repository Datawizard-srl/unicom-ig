Instance: ADVIL-CTAB-200MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-ibuprofen-PFIZER-ELLAS-AE-coated-tablet-20-x-200mg-" //pcId ?
* packageFor = Reference(ADVIL-CTAB-200MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(ADVIL-CTAB-200MG-TAB-MID)
