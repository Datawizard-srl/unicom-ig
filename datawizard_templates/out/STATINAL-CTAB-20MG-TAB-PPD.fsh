Instance: STATINAL-CTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-ALET-PHARMACEUTICALS-ABEE-coated-tablet-10-x-20mg-" //pcId ?
* packageFor = Reference(STATINAL-CTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(STATINAL-CTAB-20MG-TAB-MID)
