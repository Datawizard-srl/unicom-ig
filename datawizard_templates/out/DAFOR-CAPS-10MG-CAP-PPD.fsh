...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-PNG-GEROLUMATOS-MENTIKAL-AE-capsule-hard-14-x-10mg-" //pcId ?
...
* identifier[pcid].value = "GRC-GRC-amlodipine-besilate-PNG-GEROLUMATOS-MENTIKAL-AE-capsule-hard-28-x-10mg-" //pcId ?
* packageFor = Reference(DAFOR-CAPS-10MG-CAP-MPD)
