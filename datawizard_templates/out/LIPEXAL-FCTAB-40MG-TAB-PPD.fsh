Instance: LIPEXAL-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-INNOVIS-PHARMA-AEBE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(LIPEXAL-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(LIPEXAL-FCTAB-40MG-TAB-MID)
//* packaging.packaging.containedItem.amount.value = 30
Instance: LIPEXAL-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-PhARMATEN-ELLAS-AEBE-film-coated-tablet-60-x-40mg-" //pcId ?
* packageFor = Reference(LIPEXAL-FCTAB-40MG-TAB-MPD)
