Instance: BRUFEN-CTAB-200MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-ibuprofen-BGP-PROIONTA-MEPE-coated-tablet-30-x-200mg-" //pcId ?
* packageFor = Reference(BRUFEN-CTAB-200MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(BRUFEN-CTAB-200MG-TAB-MID)
