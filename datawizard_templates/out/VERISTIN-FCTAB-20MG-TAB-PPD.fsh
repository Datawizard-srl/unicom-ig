Instance: VERISTIN-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-VIOFAR-EPE-film-coated-tablet-28-x-20mg-" //pcId ?
* packageFor = Reference(VERISTIN-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(VERISTIN-FCTAB-20MG-TAB-MID)
//* packaging.packaging.containedItem.amount.value = 30
Instance: VERISTIN-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-VIOFAR-EPE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(VERISTIN-FCTAB-20MG-TAB-MPD)
