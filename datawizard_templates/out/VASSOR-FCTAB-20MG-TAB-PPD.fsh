Instance: VASSOR-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-PNG-GEROLUMATOS-MENTIKAL-AE-film-coated-tablet-10-x-20mg-" //pcId ?
* packageFor = Reference(VASSOR-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(VASSOR-FCTAB-20MG-TAB-MID)
//* packaging.packaging.containedItem.amount.value = 30
Instance: VASSOR-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-PNG-GEROLUMATOS-MENTIKAL-AE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(VASSOR-FCTAB-20MG-TAB-MPD)
