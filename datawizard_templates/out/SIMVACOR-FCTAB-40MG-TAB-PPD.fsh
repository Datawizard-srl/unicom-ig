Instance: SIMVACOR-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-KLEBA-APhBEE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(SIMVACOR-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(SIMVACOR-FCTAB-40MG-TAB-MID)
