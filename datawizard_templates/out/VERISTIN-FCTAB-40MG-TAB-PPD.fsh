Instance: VERISTIN-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-VIOFAR-EPE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(VERISTIN-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(VERISTIN-FCTAB-40MG-TAB-MID)
