Instance: STATIVER-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-CROSS-PHARMACEYTICALS-PC-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(STATIVER-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(STATIVER-FCTAB-40MG-TAB-MID)
