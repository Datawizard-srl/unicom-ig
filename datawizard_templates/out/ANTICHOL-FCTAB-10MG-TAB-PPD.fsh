Instance: ANTICHOL-FCTAB-10MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-HELP-ABEE-film-coated-tablet-10-x-10mg-" //pcId ?
* packageFor = Reference(ANTICHOL-FCTAB-10MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(ANTICHOL-FCTAB-10MG-TAB-MID)
