Instance: SIMVASTATIN-GENERICS-FCTAB-40MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-GENERICS-PHARMA-HELLAS-EPE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(SIMVASTATIN-GENERICS-FCTAB-40MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(SIMVASTATIN-GENERICS-FCTAB-40MG-TAB-MID)
