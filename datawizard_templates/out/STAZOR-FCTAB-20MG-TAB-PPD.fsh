Instance: STAZOR-FCTAB-20MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-ADEPhARM-MEPE-film-coated-tablet-30-x-20mg-" //pcId ?
* packageFor = Reference(STAZOR-FCTAB-20MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(STAZOR-FCTAB-20MG-TAB-MID)
