Instance: NUROFEN-FOR-CHILDREN-oralSUSP-100MG-5ML-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-ibuprofen-RB-HEALTHCARE-HELLAS-AE-oral-suspension-150mL-x-100mg-5mL" //pcId ?
* packageFor = Reference(NUROFEN-FOR-CHILDREN-oralSUSP-100MG-5ML-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(NUROFEN-FOR-CHILDREN-oralSUSP-100MG-5ML-MID)
