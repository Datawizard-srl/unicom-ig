Instance: PLACOL--SIMVASTATIN-FCTAB-40-MG-TAB-PPD
InstanceOf: PPLPackagedProductDefinition
Usage: #example

* identifier[pcid].value = "GRC-GRC-Simvastatin-BENNETT-PhARMAKEUTIKE-AE-film-coated-tablet-30-x-40mg-" //pcId ?
* packageFor = Reference(PLACOL--SIMVASTATIN-FCTAB-40-MG-TAB-MPD)
...
//* packaging.packaging.containedItem.item.reference = Reference(PLACOL--SIMVASTATIN-FCTAB-40-MG-TAB-MID)
